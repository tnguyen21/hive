...
class Orchestrator:
    ...
    def __init__(
        ...
        # Track last DB lease renewal time to debounce writes
    ...
    def _renew_lease_for_session(self, session_id: str):
        ...
        # Debounce DB writes: only extend lease if enough time has passed
        # since the last extension. 10% of extension time is a safe buffer.
