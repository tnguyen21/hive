...
⏺ OK, here's the diagnosis:
  ...
  2. Reset the 6 stuck issues so workers can be disp...
...
⏺ The run budget is exhausted — 2,116,352 tokens used and the daemon won't spawn more workers. The one session it spawned
  (ws-27...
